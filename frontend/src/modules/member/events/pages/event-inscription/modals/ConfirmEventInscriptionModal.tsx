...
import { processCancellations } from "../utils/EventInscriptionOperations";
import { toast } from "sonner";
import { Card } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { useUser } from "@/shared/context/UserContext";

type ConfirmEventIncriptionModalProps = {
    onGoToPayment: () => void
    onClose: () => void,
}

export default function ConfirmEventIncriptionModal({ onGoToPayment, onClose }: ConfirmEventIncriptionModalProps) {
    ...
    }, [account?.email, cancelledInscriptions, event, navigate, newInscriptions.length, onGoToPayment, user?.id, user?.lastname, user?.name]);
