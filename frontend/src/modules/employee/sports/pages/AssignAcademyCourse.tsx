...
import Navigation from "../components/NavigationAcademies";
import { useNavigate } from 'react-router-dom';
import SpacesAcademiesSection from "../components/SpacesAcademiesSection";
import FormAssignAcademyCourse from "../components/FormAssignAcademyCourse";

export default function AssignScheduleSpace() {
