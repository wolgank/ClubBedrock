...
export function NavigationSpaces() {
    ...
    const isEspacios = ["/employee-event/espacios"].includes(path) || /^\/employee-event\/espacios\/\d+$/.test(path);
    const isNuevoEspacio = pathname === "/employee-event/nuevo-espacio";
    const isAgregarHorario = pathname === "/employee-event/agregar-horario";

    const goEspacios = () => navigate("/employee-event/espacios");
    const goNuevoEspacio = () => navigate("/employee-event/nuevo-espacio");
    const goAgregarHorario = () => navigate("/employee-event/agregar-horario");
