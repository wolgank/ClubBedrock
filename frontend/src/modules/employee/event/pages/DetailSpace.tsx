...
import SpacesAcademiesSection from "../components/SpacesEventsSection";
...
export default function DetailSpace() {
    ...
    //     queryKey: ['get-info-reservation-space', toDelete?.id],
    //     queryFn: () => getInfoSpace(id.toString()),
    ...
    const mutation = useMutation({
        ...
        onError: (error: any) => {
            ...
            toast.error(
                <>
                    <strong>Error al eliminar reserva.</strong>
    ...
    const handleConfirmDelete = async () => {
        if (toDelete) {
            ...
            try {
                //console.log("handleConfirmDelete", toDelete.id, toDelete.name, toDelete.espacio, toDelete.correo);
    ...
    const handleRequestDelete = (id: number, name: string, espacio: string, correo: string) => {
        ...
        //console.log("handleRequestDelete", id, name, espacio);
        setModalOpen(true);
    };
    if (cargandoDatos) {
        return (
